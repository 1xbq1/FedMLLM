...
def conversation_to_ids(conversation, tokenizer, llm_type=None, new_schema=False, max_length=2048, in_type='image'):
    """
    ...
    if in_type == 'image':
        ...
        # print('len(image_start_tokens)', len(image_start_tokens))
        # print('len(image_end_tokens)', len(image_end_tokens))
...
def preprocess(
    ...
    if images_dict is not None:
        ...
        input_dict = conversation_to_ids(conversations, tokenizer, llm_type, new_schema, max_length, 'text')
